...
function App() {
    ...
    const filterTodos = todos.filter(todo => todo.description.toLowerCase().includes(debounceQuery.toLowerCase()) || todo.todo.toLowerCase().includes(debounceQuery.toLowerCase()))
